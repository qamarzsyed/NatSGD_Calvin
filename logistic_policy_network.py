...
class LogisticPolicyNetwork(ActionDecoder):
    def __init__(
        ...
        out_features=16*175,
        log_scale_min=-7,
        act_max_bound = [15.16, 54.47, 65.08, 1.31, -8.74, 25.01, -33.64, 87.51, 20.0, -10.65, 86.83, 24.31, -8.9, 28.81, -12.56, 129.0]*175,
        act_min_bound = [-15.54, 15.56, 21.08, -29.95, -93.19, 2.21, -116.42, 52.0, 0.0, -72.08, 1.54, -25.53, -120.84, -5.7, -120.69, 38.27]*175,
        dataset_dir = "",
    ...
    def forward(  # type: ignore
        ...
        latent_goal = latent_goal[0][0].unsqueeze(1).expand(-1, seq_len, -1)
